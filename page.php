...
<title> Pusoe Bakers | About Us</title>
<!--Bootstrap -->
<!--Bootstrap -->
...
<?php include('includes/menu-bar.php');?>
                      <?php
$pagetype = $_GET['type'];
$sql = "SELECT type, detail, PageName FROM pusoe_pages WHERE type = ?";
$query = mysqli_prepare($con, $sql);
mysqli_stmt_bind_param($query, "s", $pagetype);
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <section class="page-header Aboutus_page">
            <div class="container">
                <div class="page-header_wrap" style="color:black!important;">
