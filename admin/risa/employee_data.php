			...
			<form class="form-inline" method="get">
				<div class="form-group">
					<select name="filter" class="form-control" onchange="form.submit()">
						...
						<option value="Permanent" <?php if($filter == 'Permanent'){ echo 'selected'; } ?>> Permanent</option>
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						echo '
							...
							<td>
								...
								<a href="index.php?aksi=delete&national_id='.$row['national_id'].'" title="Delete" onclick="return confirm(\'Are yousure you want to delete user  '.$row['employee_name'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
						$no++;
